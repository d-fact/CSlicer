...
BASE_DIR = os.path.expanduser("~/Projects/gitslice")  # change this to the path to CSlicer
...
CSLICER_JAR_PATH = BASE_DIR + '/target/cslicer-1.0.0-jar-with-dependencies.jar'
REPO_DIR_SFX = "-fake"
