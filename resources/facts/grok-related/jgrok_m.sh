...
# Example: ./jgrok_m.sh diffDeps.ql ../../../_downloads/commons-csv/.facts

START_TIME=$(date +%s)

# set your JGROK_HOME
# JGROK_HOME="/home/wuxh/Projects/code_change/grok/jGrok/jgrok-1.0.7/1.0.7"
JGROK_HOME="/home/cgzhu/projects/gitslice/resources/facts/jgrok_dev"
