...
public class LogFileVerifierMain_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.pinterest.secor.main.LogFileVerifierMain"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(LogFileVerifierMain_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.pinterest.secor.main.LogFileVerifierMain",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(LogFileVerifierMain_ESTest_scaffolding.class.getClassLoader()); 
