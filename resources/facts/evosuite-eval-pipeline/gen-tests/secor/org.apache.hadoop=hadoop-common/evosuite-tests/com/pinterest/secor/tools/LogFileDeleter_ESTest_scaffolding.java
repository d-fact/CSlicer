...
public class LogFileDeleter_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.pinterest.secor.tools.LogFileDeleter"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(LogFileDeleter_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.pinterest.secor.tools.LogFileDeleter",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(LogFileDeleter_ESTest_scaffolding.class.getClassLoader()); 
