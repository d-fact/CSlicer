...
public class RequestPropsInjecterTransformer_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.restheart.metadata.transformers.RequestPropsInjecterTransformer"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(RequestPropsInjecterTransformer_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(RequestPropsInjecterTransformer_ESTest_scaffolding.class.getClassLoader()); 
