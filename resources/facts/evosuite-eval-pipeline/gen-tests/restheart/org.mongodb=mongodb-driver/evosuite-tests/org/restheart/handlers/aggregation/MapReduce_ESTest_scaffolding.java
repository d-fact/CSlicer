...
public class MapReduce_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.restheart.handlers.aggregation.MapReduce"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(MapReduce_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.bson.codecs.Codec", false, MapReduce_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.bson.codecs.configuration.CodecRegistry", false, MapReduce_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(MapReduce_ESTest_scaffolding.class.getClassLoader()); 
