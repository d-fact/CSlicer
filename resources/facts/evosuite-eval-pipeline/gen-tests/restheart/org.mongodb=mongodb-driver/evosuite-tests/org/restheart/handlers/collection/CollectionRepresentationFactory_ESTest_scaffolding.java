...
public class CollectionRepresentationFactory_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.restheart.handlers.collection.CollectionRepresentationFactory"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CollectionRepresentationFactory_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.restheart.handlers.collection.CollectionRepresentationFactory$1",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.bson.codecs.configuration.CodecRegistry", false, CollectionRepresentationFactory_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CollectionRepresentationFactory_ESTest_scaffolding.class.getClassLoader()); 
