...
public class JsonSchemaChecker_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.restheart.metadata.checkers.JsonSchemaChecker"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(JsonSchemaChecker_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.bson.codecs.Codec", false, JsonSchemaChecker_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.bson.codecs.configuration.CodecRegistry", false, JsonSchemaChecker_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(JsonSchemaChecker_ESTest_scaffolding.class.getClassLoader()); 
