...
public class LogFileVerifier_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.pinterest.secor.tools.LogFileVerifier"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(LogFileVerifier_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.pinterest.secor.tools.LogFileVerifier",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(LogFileVerifier_ESTest_scaffolding.class.getClassLoader()); 
