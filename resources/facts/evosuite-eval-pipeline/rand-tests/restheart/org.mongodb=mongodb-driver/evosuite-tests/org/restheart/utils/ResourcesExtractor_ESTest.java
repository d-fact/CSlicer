...
public class ResourcesExtractor_ESTest extends ResourcesExtractor_ESTest_scaffolding {
  ...
  public void test4()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        ResourcesExtractor.deleteTempDir("no resource to extract from path  {}", mockFile0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test6()  throws Throwable  {
      try { 
        ResourcesExtractor.extract(" a> iQtioLogicyous=");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // no resource to extract from path  a> iQtioLogicyous=
         //
