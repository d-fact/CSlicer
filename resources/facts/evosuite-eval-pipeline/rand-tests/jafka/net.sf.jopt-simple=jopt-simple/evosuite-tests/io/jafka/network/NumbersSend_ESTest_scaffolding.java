...
public class NumbersSend_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "io.jafka.network.NumbersSend"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(NumbersSend_ESTest_scaffolding.class.getClassLoader() ,
      "io.jafka.network.NumbersSend$IntegersSend",
      "io.jafka.mx.IMBeanName",
      "io.jafka.network.Send",
      "io.jafka.common.ErrorMapping",
      "io.jafka.utils.Utils",
      "io.jafka.network.AbstractTransmission",
      "io.jafka.network.AbstractSend",
      "io.jafka.utils.KV",
      "io.jafka.network.Transmission",
      "io.jafka.network.NumbersSend",
      "io.jafka.network.NumbersSend$LongsSend"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(NumbersSend_ESTest_scaffolding.class.getClassLoader()); 
